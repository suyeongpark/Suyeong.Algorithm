...
{
    /// <summary>
    /// 차후에 C++ Open CV 연동해서 처리하게 할 것
    /// 전반적으로 코드 자체에도 문제가 많다. 
    /// </summary>

    public static class ImageTableDetector
    {
        ...
        //public static ImageTableCollection GetTables(
        //    string imagePath, 
        //    int textSize, 
        ...
        //)
        //{
        //    CellLineCollection horizontals, verticals;
        ...
        //    int lineDistance = GetLineDistanceByModeThickness(horizontals: horizontals, verticals: verticals);

        //    CellBoxCollection cellBoxes = DetectCellBoxes(
        //        lineDistance: lineDistance, 
        //        horizontals: ref horizontals, 
        //        verticals: ref verticals
        //    );

        //    ImageTableCollection tables = DetectTables(
        //        cellBoxes: cellBoxes, 
        //        pageWidth: pageWidth, 
        ...
        //    string imagePath, 
        //    int textSize, 
        //    out CellLineCollection horizontals, 
        //    out CellLineCollection verticals, 
        //    out int pageWidth, 
        //    out int pageHeight
        //)
        //{
        //    horizontals = new CellLineCollection();
        //    verticals = new CellLineCollection();
        //    pageWidth = 0;
        //    pageHeight = 0;
        ...
        //static CellLineCollection DetectHorizontalLines(
        //    Mat binary, 
        //    int hThreshold, 
        //    int textSize
        //)
        //{
        //    CellLineCollection horizontals = new CellLineCollection();
        ...
        //    return new CellLineCollection(horizontals.OrderBy(line => line.CenterY));
        //}

        //static CellLineCollection DetectVerticalLines(
        //    Mat binary, 
        //    int vThreshold, 
        //    int textSize, 
        //    int startIndex
        //)
        //{
        //    CellLineCollection verticals = new CellLineCollection();
        ...
        //    return new CellLineCollection(verticals.OrderBy(line => line.CenterX));
        //}


        //// 최빈값 기준으로 찾기
        //static int GetLineDistanceByModeThickness(
        //    IEnumerable<CellLine> horizontals, 
        //    IEnumerable<CellLine> verticals
        //)
        //{
        ...
        //static CellBoxCollection DetectCellBoxes(
        //    int lineDistance, 
        //    ref CellLineCollection horizontals, 
        //    ref CellLineCollection verticals
        //)
        //{
        //    CellBoxCollection cellBoxes = new CellBoxCollection();

        //    CellLineCollection horizontalsFinal, verticalsFinal;
        ...
        //                {
        //                    if (horizontal.MinX <= vertical.MaxX && 
        //                        horizontal.MaxX >= vertical.MinX && 
        //                        horizontal.MinY <= vertical.MaxY && 
        //                        horizontal.MaxY >= vertical.MinY)
        //                    {
        ...
        //                        if (ExistBottomLine(
        //                            topIndex: horizontal.Index, 
        //                            lineDistance: lineDistance, 
        //                            verticalLeft: left, 
        //                            verticalRight: right, 
        //                            horizontals: horizontals, 
        //                            duplicateDic: ref duplicateDic, 
        //                            bottom: out bottom))
        //                        {
        //                            top = horizontal;
        ...
        //                            // 이거 코드 잘못된거 같은데 차후에 고칠 것. 반복문을 돌고 있는데 컬렉션을 수정하고 있다.
        //                            horizontals = GetHorizonsAllInBox(
        //                                lineDistance: lineDistance, 
        //                                top: top, 
        //                                bottom: bottom, 
        //                                left: left, 
        ...
        //                                left: left, 
        //                                right: right, 
        //                                innerHorizontals: horizontals, 
        //                                innerVerticals: verticals, 
        //                                duplicateDic: ref duplicateDic, 
        //                                horizontalsFinal: out horizontalsFinal, 
        //                                verticalsFinal: out verticalsFinal
        //                            );

        //                            cellBoxes.Add(new CellBox(
        //                                index: index++, 
        //                                horizontals: new CellLineCollection(horizontalsFinal.OrderBy(line => line.StartY)), 
        //                                verticals: new CellLineCollection(verticalsFinal.OrderBy(line => line.StartX)))
        //                            );
        ...
        //static bool ExistBottomLine(
        //    CellLine verticalLeft, 
        //    CellLine verticalRight, 
        //    IEnumerable<CellLine> horizontals, 
        //    int topIndex, 
        //    int lineDistance, 
        //    ref Dictionary<int, int> duplicateDic, 
        //    out CellLine bottom
        //)
        //{
        //    bottom = new CellLine();
        ...
        //    {
        //        if (!duplicateDic.ContainsKey(horizontal.Index) && 
        //            horizontal.Index != topIndex &&
        //            // 두 수직선과 끝점이 만나야 함
        //            Math.Abs(horizontal.StartX - verticalLeft.StartX) <= lineDistance &&
        ...
        //static CellLineCollection GetHorizonsAllInBox(
        //    CellLine top, 
        //    CellLine bottom, 
        //    CellLine left, 
        //    CellLine right,
        ...
        //)
        //{
        //    CellLineCollection horizontalsAll = new CellLineCollection();
        ...
        //static CellLineCollection GetVerticalAllInBox(
        //    CellLine top, 
        //    CellLine bottom, 
        //    CellLine left, 
        //    CellLine right, 
        ...
        //)
        //{
        //    CellLineCollection verticalsAll = new CellLineCollection();
        ...
        //static void RemoveNoiseLine(
        //    CellLine top, 
        //    CellLine bottom, 
        //    CellLine left, 
        //    CellLine right,
        //    IEnumerable<CellLine> innerHorizontals,
        //    IEnumerable<CellLine> innerVerticals,
        //    int lineDistance, 
        //    ref Dictionary<int, int> duplicateDic, 
        //    out CellLineCollection horizontalsFinal, 
        //    out CellLineCollection verticalsFinal
        //)
        //{
        //    // 최종적으로 찾은 것을 duplicateDic에 추가한다. (이렇게 하면 박스 안의 박스는 별도로 처리 가능)
        //    horizontalsFinal = new CellLineCollection();
        //    verticalsFinal = new CellLineCollection();

        //    CellLineCollection horizontals = new CellLineCollection();
        //    CellLineCollection verticals = new CellLineCollection();
        //    CellLineCollection horizontalFirst = new CellLineCollection();
        //    CellLineCollection verticalFirst = new CellLineCollection();
        ...
        //    CellLineCollection horizontalSecond, verticalSecond, horizontalThird, verticalThird, horizontalFourth, verticalFourth;

        //    GetInsideLine(
        //        horizontalSamples: horizontalFirst, 
        //        verticalSamples: verticalFirst, 
        //        lineDistance: lineDistance, 
        //        horizontals: ref horizontals, 
        //        verticals: ref verticals, 
        //        horizontalRests: out horizontalSecond, 
        //        verticalRests: out verticalSecond
        //    );
            
        //    GetInsideLine(
        //        horizontalSamples: horizontalSecond, 
        //        verticalSamples: verticalSecond, 
        //        lineDistance: lineDistance, 
        //        horizontals: ref horizontals, 
        //        verticals: ref verticals, 
        //        horizontalRests: out horizontalThird, 
        //        verticalRests: out verticalThird
        //    );
            
        //    GetInsideLine(
        //        horizontalSamples: horizontalThird, 
        //        verticalSamples: verticalThird, 
        //        lineDistance: lineDistance, 
        //        horizontals: ref horizontals, 
        //        verticals: ref verticals, 
        //        horizontalRests: out horizontalFourth, 
        //        verticalRests: out verticalFourth
        //    );
        ...
        //static void GetInsideLine(
        //    IEnumerable<CellLine> horizontalSamples, 
        //    IEnumerable<CellLine> verticalSamples, 
        //    int lineDistance, 
        //    ref CellLineCollection horizontals, 
        //    ref CellLineCollection verticals, 
        //    out CellLineCollection horizontalRests, 
        //    out CellLineCollection verticalRests
        //)
        //{
        //    horizontalRests = new CellLineCollection();
        //    verticalRests = new CellLineCollection();
        ...
        //static ImageTableCollection DetectTables(
        //    IEnumerable<CellBox> cellBoxes, 
        //    int pageWidth, 
        //    int pageHeight, 
        //    int lineDistance, 
        //    int textSize
        ...
        //    CrossPointCollection crossPoints;
        ...
        //        {
        //            // 교차점을 구한다.
        //            crossPoints = DetectRawCrossPoints(
        //                horizontals: box.Horizontals, 
        //                verticals: box.Verticals, 
        //                lineDistance: lineDistance, 
        //                crossPointIndexes: out crossPointIndexes
        //            );

        //            // 일단 cell을 구한다.
        //            cells = DetectRawCells(
        //                crossPoints: crossPoints, 
        //                crossPointIndexes: crossPointIndexes, 
        ...
        //static CrossPointCollection DetectRawCrossPoints(
        //    List<CellLine> horizontals, 
        //    List<CellLine> verticals, 
        //    int lineDistance, 
        //    out int[,] crossPointIndexes
        //)
        //{
        //    crossPointIndexes = new int[horizontals.Count, verticals.Count];

        //    CrossPointCollection rawCrossPoints = new CrossPointCollection();
        ...
        //            // 두선이 교차하는지 확인
        //            if (horizontal.StartX <= vertical.StartX && 
        //                horizontal.EndX >= vertical.EndX && 
        //                horizontal.StartY >= vertical.StartY && 
        //                horizontal.EndY <= vertical.EndY)
        //            {
        ...
        //                rawCrossPoints.Add(new CrossPoint(
        //                    index: index, 
        ...
        //static ImageCellCollection DetectRawCells(
        //    List<CrossPoint> crossPoints, 
        //    int[,] crossPointIndexes, 
        //    int spacingMin, 
        //    double widthRatio, 
        //    double heightRatio
        ...
        //            {
        //                leftColumnIndex = FindLeftColumnIndex(
        //                    rowIndex: current.RowIndex, 
        //                    columnIndex: current.ColumnIndex, 
        //                    crossPointIndexes: crossPointIndexes, 
        //                    rawCrossPoints: crossPoints
        //                );

        //                topRowIndex = FindTopRowIndex(
        //                    rowIndex: current.RowIndex, 
        //                    columnIndex: current.ColumnIndex, 
        //                    crossPointIndexes: crossPointIndexes, 
        //                    rawCrossPoints: crossPoints
        ...
        //static int FindLeftColumnIndex(
        //    int rowIndex, 
        //    int columnIndex, 
        //    int[,] crossPointIndexes,
        //    List<CrossPoint> rawCrossPoints
        //)
        //{
